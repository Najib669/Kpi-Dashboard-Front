...
const Datatable = () => {
  ...
  console.log('ghhgghhh', filteredData);
  return (
    <Box style={{ width: '100%' }}>
          ...
          <LocalizationProvider dateAdapter={AdapterDayjs}>
            <DemoContainer components={['DatePicker', 'DatePicker']}>
              ...
              <DatePicker
                ...
                sx={{ width: '100%', '& input': { fontSize: '14px' } }}
              />
              {/* End date picker */}
              <DatePicker
                label="Date de fin"
      ...
      {/* Data table */}
      <StyledTable style={{ height: 340, width: '100%' }}>
        <TableHead>
          <TableRow>
            <TableCell align="center">Intitulée</TableCell>
            <TableCell align="center">Nombre de Dossiers</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
